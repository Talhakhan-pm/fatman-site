        ...
        <div>
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            {isAdmin && (
              <button 
                onClick={() => {
                  window.location.href = `/admin/catalog?slug=${product.slug}`;
                }}
                className="relative z-50 cursor-pointer pointer-events-auto rounded-full border border-fatman-accent/40 bg-fatman-accent/10 px-3 py-1 text-xs font-semibold text-fatman-accent hover:bg-fatman-accent/20 hover:border-fatman-accent/60 transition-colors flex items-center gap-1.5"
              >
