        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 sm:px-8">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3">
            {categories.map((cat, i) => (
              <Link key={cat.slug} href={`/category/${cat.slug}`} className="group relative overflow-hidden border border-white/[0.06] bg-[#1a1d24] transition-all duration-300 hover:translate-y-[-3px] hover:border-[#ff6a00]/40 hover:shadow-[0_12px_40px_rgba(255,106,0,0.12)]" style={{ animationDelay: `${i * 0.08}s` }}>
