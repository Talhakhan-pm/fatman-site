          ...
          {categories.map((cat) => {
            ...
            return (
              <Link
                ...
                className="group relative overflow-hidden rounded-xl border border-white/[0.06] bg-[#1a1d24] transition-all duration-300 hover:translate-y-[-2px] hover:border-[#ff6a00]/40 active:scale-[0.97] sm:rounded-none"
              >
                <div className="relative h-28 overflow-hidden border-b border-white/[0.06] bg-gradient-to-br from-white/[0.04] to-white/[0.01] sm:h-44">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center p-3 sm:p-8">
                    <div className="h-14 w-14 text-white/[0.35] transition-all duration-500 group-hover:scale-110 group-hover:text-[#ff6a00]/60 sm:h-28 sm:w-28">
                      <Icon />
                    </div>
                  </div>
                  <span className="absolute left-4 top-4 hidden rounded-full border border-white/15 bg-black/35 px-2.5 py-1 text-[10px] uppercase tracking-[0.18em] text-white/80 backdrop-blur-sm sm:block">
                    {cat.title}
                  </span>
                </div>
                <div className="p-3.5 sm:p-6">
                  <h2 className="text-[13px] font-black uppercase leading-tight tracking-wide text-white transition-colors group-hover:text-[#ff6a00] sm:text-lg">
                    {cat.title}
                  </h2>
                  <p className="mt-1.5 line-clamp-2 text-[11px] leading-snug text-white/40 sm:mt-2 sm:text-sm sm:leading-relaxed">
                    {cat.description}
                  </p>
                  <span className="mt-2 inline-flex items-center gap-1 font-mono text-[11px] font-bold text-[#ff6a00] sm:mt-4 sm:text-sm">
